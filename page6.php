            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="text" autocomplete="off" placeholder="Imong sabat" name="l1_u3_01" id="" style="width:100%;text-transform:uppercase;"><br><br>
                  <p class="card-text"><b>2.</b> Ginakaon naton ra. May palikpik ag himbis ra. Nagaeangoy ra sa tubi. Raya hay ____________.</p>
                  <input type="text" autocomplete="off"  placeholder="Imong sabat" name="l1_u3_02" id="" style="width:100%;text-transform:uppercase;"><br><br>
                  ...
                  <input type="text" autocomplete="off" placeholder="Imong sabat" name="l1_u3_03" id="" style="width:100%;text-transform:uppercase;"><br><br>
                  ...
                  <input type="text" autocomplete="off" placeholder="Imong sabat" name="l1_u3_04" id="" style="width:100%;text-transform:uppercase;"><br><br>
                  ...
                  <input type="text" autocomplete="off"  placeholder="Imong sabat" name="l1_u3_05" id="" style="width:100%;text-transform:uppercase;"><br><br>
