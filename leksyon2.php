    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Leksyon 2</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <footer class="text-center page">11</footer>
                </div>
              </div>
            </div>
            <!-- pg11 end -->
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Tandaan!</p>
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body card-style">
                        <p class="card-text">• Ro Pangngaean hay pwedeng hueayon sa daywa: mga pangaean nga MAHUYAP ag mga pangaean nga INDI MAHUYAP.</p>
                        <p class="card-text">• Ginatawag nga <ins>pangngaean nga mahuyap</ins> (<b>count nouns</b>) ro mga pangngaean nga mahuyap it tig-sambilog o binato bato. Ginadungangan it bisaea nga "mga" ro pangngaean nga "sambilog" ro kahueugan (<b>singular</b>) agud maporma ro pangngaean nga "abu" rayon ro kahueugan (<b>Plural</b>)</p>
                        <p class="card-text">Halimbawa:<br>
                          bueak - mga bueak<br>
                          bulador - mga bulador<br>
                          daean - mga daean<br>
                          amigo - mga amigo</p>
                          <p class="card-text">• Ro mga <ins>pangngaean nga indi mahuyap</ins> (<b>mass noun</b>) hay mga butang nga indi gid mahuyap it tig-sambilog o binato bato. Pilang halimbawa sa mga pangaean ngara hay:<br>
                            bugas &nbsp; arina &nbsp; mantika &nbsp; asukar</p>
                      </div>
                    </div>
                    <footer class="text-center page">12</footer>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              ...
              <footer class="text-center page">13</footer>
              <!-- End Bordered Table -->
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="card-title bold">Ueubrahon 3</div>
                  ...
                  <form method ="post" action ="">
                  <div class="row">
                    <p class="card-text"><ins>Mga Pangngaen nga indi Mahuyap</ins><br><br> 1. Ro pag-inom it maabu nga <ins>kape</ins> hay makapabugtaw kimo. <input type="text" name="l2_u3_01" style="width:100%;" required placeholder="Imong sabat"></p>
                    <p class="card-text"> 2. gamitan ko it ___________ ro akon nga panit agud indi magmaea. <input type="text" name="l2_u3_02" style="width:100%;" required placeholder="Imong sabat"></p>
                    <p class="card-text"> 3. ro mga Pilipino hay nagakaon nga may ___________ ag tinidor. <input type="text" name="l2_u3_03" style="width:100%;" required placeholder="Imong sabat"></p>
                    <p class="card-text"> 4. Ro pag-inom it sangkabaso ga ___________ sa sang adlaw hay mayad sa imong tue-an. <input type="text" name="l2_u3_04" style="width:100%;" required placeholder="Imong sabat"></p>
                    <p class="card-text"> 5. Kinahangean naton nga mag-inom it waeong ka baso it ___________ hambae it doktor. <input type="text" name="l2_u3_05" style="width:100%;" required placeholder="Imong sabat"></p>
                    <p class="card-text"> 6. Nagakinahangean si nanay it limang ________________ para sa anang ginaeaha. <input type="text" name="l2_u3_06" style="width:100%;" required placeholder="Imong sabat"></p>
                  </div>
                  <div style="text-align:right">
                    <br>
                    <input type="submit" name="submit" value="Submit Answers" style="background:#4154f1;color:white;border-radius:10px;">
                ...
                <footer class="text-center page">14</footer><br>
              </div>
            </div>
            <!-- pg14 nnd -->
            <!-- pg15 -->
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="card-title bold text-center">Basahon ag Tun-an!</div>
                  <div class="card-text">Basaha it mabaskug ro istorya.</div><br>
                  <div class="card-text text-center bold">Mga Maduga nga Prutas (Juicy, Juicy, Fruits)</div>
                  <p class="card-text text-center">ni: Nelia D. Bamba</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Bip, bip, bip!" "Iya eon ro <b>bus</b>!" nagdaeaguso sa pagbitbit it andang mga bag ro mga unga.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Mauli eon kita, Byernes eon man!" hambae ku mga unga.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Mga unga, tanan hay saka eon sa saeakyan," Indi eot a mag-andar ro makina.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Maulihi eang kita it sangkiri sa pag-uli, pero indi kamo mahawag hay maisut malang ra nga problema". Mabaskog nga nagpanghayhay ro mga unga. "Eaum ko hay makatan-aw eon ako ku akong paborito nga paguwa sa telibisyon" hambae ni Ashlyn.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Wow! Tan-aw sa guwa! Tanan kamo, tan-aw sa guwa! Tan-awa ratong mga melon, mga suwa, mga pinya, ag mga bayawas sa baealigyaan. Preska gid a tan-awon," hambae ni Belle.</p>
                ...
                <footer class="text-center page">15</footer><br>
              </div>
            </div>
            <!-- pg15 end -->
            <!-- pg16 -->
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <br>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Kunta nakita ni nanay rayang mga prutas. Sigurado nga mabakae gid imaw, " hambae ni Miguel. "Naila gid ako magkaon it mga prutas. Mayad ra sa atong eawas," hambae ni nanay.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Oy, hadumduman ninyo ro atong gin-obra sa klase kainang agahon?" hambae ni Akia.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Ay huo, nag-obra kita it <b>rap</b> ag <b>chant</b> sa klase ni Mam Reyes hanungod sa mga pagkaon nga mayad sa atong eawas," sabat ni Aaron.</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Imbis nga tak-an kita samtang nagahueat, musyon ma-<b>rap</b> kita," singgit ni Xavier. DAyon, nag-umpisa imaw sa pag-<b>rap</b>:</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp; "Mga melon, mga melon, maduga, maduga, maduga. Mga melon nga maduga, maduga nga mga melon (Tama!)"</p>
                  <p class="card-text">&nbsp; &nbsp; &nbsp;Naila gid ako it maduga nga melon.</p>
                ...
                <footer class="text-center page">16</footer><br>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="card-title bold">Basahon ag Tun-an!</div>
                  <p class="card-text">Basaha ro istorya ag sabtan ro masunod nga mga pangutana.</p>
                  <p class="card-text">&nbsp;&nbsp;&nbsp;&nbsp;Nagdaeagan si Brent paadto sa baraka. Mabakae imaw it asin nga pagagamiton ni nanay na sa pag-eaha it ilabas. Nakita na ro anang amigo nga si Rolly sa baraka. Ginpakita kana ni Rolly ro anang bag-ong hampangan nga robot. Naila gid a si Brent sa hampangan. Sa hinali, ginpangutana imaw ni Nay Maring. "Mabakae ka?" Gintueok eang ni Brent si Nay Maring. Halipatan na eon ro ginapabakae kana ni nanay na. Ginpangutana imaw ni Nay Maring kon ano ro gina-obra ni nanay na. Nagahiyum-hiyum nga nagsabat si Brent. "Nagaeaha imaw it ilabas. Kinahangean ko magbakae it samputos nga asin." Sa anang paghalin sa baraka, nagpasaeamat si Brent kay Nay Maring sa pagpadumdum kana.</p>
                  <p class="card-text">
                    Ano ro ay Brent nga problema?<br>
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <footer class="text-center page">22</footer>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body"><br>
                  ...
                  <footer class="text-center page">23</footer>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <footer class="text-center page">24</footer>
                </div>
              </div>
            </div>
          </div>
