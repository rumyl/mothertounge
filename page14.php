              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    <footer class="text-center page">14</footer>
                </div>
                <div class="navigation-buttons">
                                <a href="page13.php"><button class="btn btn-primary float-left">Previous</button></a>
                                <a href="page15.php"><button class="btn btn-primary float-right">Next</button></a>
